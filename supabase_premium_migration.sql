...
insert into public.custom_themes (name, description, css_variables, is_premium) values
('Handdrawn', 'Default sketchy hand-drawn style', '{"--bg-color": "#f9f9f9", "--text-color": "#333333"}', false),
('Minimal', 'Clean and minimal design', '{"--bg-color": "#ffffff", "--text-color": "#000000"}', true),
('Modern', 'Sleek modern interface', '{"--bg-color": "#1a1a1a", "--text-color": "#ffffff"}', true),
('Glassmorphism', 'Frosted glass effect', '{"--bg-color": "rgba(255,255,255,0.1)", "--backdrop-filter": "blur(10px)"}', true)
